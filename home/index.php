			...
			<div class="container marketing" id="home-marketing">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img class="img-circle" src="../images/pro.png" alt="Generic placeholder image" width="100" height="100">
						<h2>Professional</h2>
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img class="img-circle" src="../images/fast.png" alt="Generic placeholder image" width="100" height="100">
						<h2>Fast</h2>
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img class="img-circle" src="../images/scale.png" alt="Generic placeholder image" width="100" height="100">
						<h2>Scalable</h2>
				...
				<div class="row featurette" id="feature-professional">
					...
					<div class="col-md-5">
						<img class="featurette-image img-responsive center-block" src="../images/feature1.png" alt="Professional">
					</div>
				</div>
				...
				<div class="row featurette" id="feature-fast">
					...
					<div class="col-md-5 col-md-pull-7">
						<img class="featurette-image img-responsive center-block" src="../images/feature2.jpg" alt="Fast">
					</div>
				</div>
